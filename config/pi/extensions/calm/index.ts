...
//
// Re-verified against Pi 0.84.4; see the onTerminalInput local delta below.
...
export default function (pi: ExtensionAPI) {
  ...
  pi.on("session_start", (_event, ctx) => {
    ...
    // Local delta from upstream: Pi 0.84 widened the onTerminalInput handler
    // return type from void to { consume?, data? } | undefined. Returning
    // undefined is the old void behavior - observe only, never consume or
    // rewrite the keystroke - so this annotation is behavior-preserving.
